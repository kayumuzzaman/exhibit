...
| Area                 | Evidence                                                                                                                                             |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Quality gate         | 2026-07-31 clean-tree `pnpm release:artifact` at `0721fcd` exit 0: 1,009 tests, 43 E2E, coverage above 90%                                           |
...
| Artifact             | Commit `0721fcd`, clean tree — `exhibit-0.1.0-chrome.zip`, 226,080 bytes; ZIP SHA-256 `d6db4790…f7cb4a`, reproducible content hash `7190099a…c1dfc9` |
